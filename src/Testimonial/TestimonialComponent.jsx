...
const TestimonialCarousel = () => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto py-5 lg:py-10">
      <div className="p-7 md:p-10 xl:p-0">
        <div className="testimonial-card bg-[#F3F3F3] p-6 rounded-xl">
          <div className="testimonial-content flex flex-col gap-y-10 lg:flex-row items-center justify-center transition-all duration-500">
            <div className="testimonial-image w-1/3 rounded-full">
              <img
            ...
            <div className="testimonial-text w-full lg:w-2/3">
              ...
              <p className="text-[#0A071B]/50 text-xs lg:text-sm font-bold">
        ...
        <div className="testimonial-buttons flex justify-end items-center -mt-7 mr-5 md:mr-7 lg:-mt-10 gap-x-5">
